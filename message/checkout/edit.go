...
func (m *CheckOut) EditFields() []*message.EditField {
	if m.edit == nil {
		m.edit = new(checkOutEdit)
...
func (m *CheckOut) ApplyEdits() {
	m.fromEdit()
	m.toEdit()
	m.validate()
}

func (m *CheckOut) toEdit() {
