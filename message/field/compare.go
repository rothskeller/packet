...
// from the comparison.
func CompareNone(string, string, string) *ComparedField {
	return nil
}

// CompareCardinal compares two values for a field that is supposed to contain
// a cardinal number.
func CompareCardinal(label, exp, act string) (c *ComparedField) {
...
func CompareCheckbox(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
...
func CompareDate(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
		Label: label, Expected: exp, Actual: act, Score: 2, OutOf: 2,
	}
	if exp == act {
...
// exactly identical.
func CompareExact(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
		Label: label, Expected: exp, Actual: act, OutOf: 2,
	}
	if exp == act {
...
// CompareExactCI compares two values for a field, which are expected to be
// exactly identical, but with a case-insensitive comparison.
func CompareExactCI(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
		Label: label, Expected: exp, Actual: act, OutOf: 2,
	}
...
// real number.
func CompareReal(label, exp, act string) (c *ComparedField) {
...
func CompareTime(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
		Label: label, Expected: exp, Actual: act, Score: 2, OutOf: 2,
	}
	if exp == act {
...
func ComparePhoneNumber(label, exp, act string) (c *ComparedField) {
	c = &ComparedField{
		Label: label, Expected: exp, Actual: act, Score: 2, OutOf: 2,
	}
...
func CompareText(label, exp, act string) (c *ComparedField) {
	var et, at []token
