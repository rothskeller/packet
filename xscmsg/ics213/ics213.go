...
func create(version *message.FormVersion) message.Message {
	...
	if f.Form.Version < "2.2" {
		f.Fields = append(f.Fields,
			message.NewMessageNumberField(&message.Field{
				...
				PDFRenderer: &message.PDFTextRenderer{X: 323, Y: 36, W: 64, H: 17, VAlign: "baseline"},
	...
	f.Fields = append(f.Fields,
		message.NewMessageNumberField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 520, Y: 36, W: 60, H: 17, VAlign: "baseline"},
		}),
		message.NewDateField(true, &message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 49, Y: 115, W: 55, H: 19, VAlign: "baseline"},
		...
		message.NewTimeField(true, &message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 143, Y: 115, W: 43, H: 19, VAlign: "baseline"},
	...
	f.Fields = append(f.Fields,
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 61, Y: 167, W: 222, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 61, Y: 202, W: 222, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 61, Y: 239, W: 222, H: 19, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 61, Y: 274, W: 222, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 340, Y: 167, W: 226, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 340, Y: 202, W: 226, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 340, Y: 239, W: 226, H: 19, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 340, Y: 274, W: 226, H: 20, VAlign: "baseline"},
			EditWidth:   40,
		...
		message.NewMultilineField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 40, Y: 365, W: 539, H: 121, VAlign: "top"},
			EditWidth:   80,
			Multiline:   true,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 123, Y: 590, W: 184, H: 18, VAlign: "baseline"},
			Compare:     message.CompareNone,
			EditWidth:   36,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 377, Y: 590, W: 183, H: 18, VAlign: "baseline"},
			Compare:     message.CompareNone,
			EditWidth:   36,
		...
		message.NewTextField(&message.Field{
			...
			PDFRenderer: &message.PDFTextRenderer{X: 188, Y: 673, W: 100, H: 20, VAlign: "baseline"},
			Compare:     message.CompareNone,
		}),
		message.NewDateField(true, &message.Field{
			Label:       "Operator: Date",
			...
			PDFRenderer: &message.PDFTextRenderer{X: 354, Y: 673, W: 56, H: 20, VAlign: "baseline"},
			Compare:     message.CompareNone,
		}),
		message.NewTimeField(true, &message.Field{
			Label:       "Operator: Time",
			...
			PDFRenderer: &message.PDFTextRenderer{X: 498, Y: 673, W: 40, H: 20, VAlign: "baseline"},
			Compare:     message.CompareNone,
		}),
		message.NewDateTimeField(&message.Field{
