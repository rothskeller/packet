...
var retrieveTests = []struct {
	...
	{
		name:      "no plain text",
		retrieved: "Content-Type: text/html\n\n<div>nothing</div>",
		bbs:       "bbs",
		wantErr:   true,
		env: &Envelope{
			ReceivedBBS:  "bbs",
	...
	},
	{
		...
		retrieved: "Content-Transfer-Encoding: quoted-printable\n\nn=6fthing\n",
		bbs:       "bbs",
		env: &Envelope{
			ReceivedBBS:  "bbs",
			ReceivedDate: time.Date(2023, 1, 1, 0, 0, 0, 0, time.Local),
	...
	{
		name:      "base64 (MIME)",
		retrieved: "Content-Transfer-Encoding: base64\n\nbm90aGluZwo=\n",
		bbs:       "bbs",
		env: &Envelope{
			ReceivedBBS:  "bbs",
			ReceivedDate: time.Date(2023, 1, 1, 0, 0, 0, 0, time.Local),
	...
	},
	{
		...
		retrieved: "Content-Type: multipart/alternative; boundary=\"X\"\n\n\n--X\nContent-Type: text/plain\n\nnothing\n\n--X--\n",
		bbs:       "bbs",
		env: &Envelope{
			ReceivedBBS:  "bbs",
			ReceivedDate: time.Date(2023, 1, 1, 0, 0, 0, 0, time.Local),
	...
	},
	{
		...
		retrieved: "Content-Type: multipart/mixed; boundary=\"Y\"\n\n\n--Y\nContent-Type: multipart/alternative; boundary=\"X\"\n\n\n--X\nContent-Type: text/plain\n\nnothing\n\n--X--\n\n--Y--\n",
		bbs:       "bbs",
		env: &Envelope{
			ReceivedBBS:  "bbs",
			ReceivedDate: time.Date(2023, 1, 1, 0, 0, 0, 0, time.Local),
	...
	{
		name:      "envelope line",
		retrieved: "From nobody@nowhere Wed Dec  1 08:04:29 2021\n\nnothing\n",
		bbs:       "bbs",
		env: &Envelope{
			ReceivedBBS:     "bbs",
			ReceivedDate:    time.Date(2023, 1, 1, 0, 0, 0, 0, time.Local),
