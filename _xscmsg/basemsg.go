...
// NewBaseMessage creates a new base message overlaying the supplied pktmsg
// message.  This is not usable without being embedded in a higher-level message
// type.  If the supplied pktmsg message is nil, a new blank message is created.
func NewBaseMessage(pkt *pktmsg.Message) *Message {
	return &Message{new(pktmsg.Message)}
}
