...
var referenceText = map[reference]string{
  ...
  * The "Weekly SPECS/SVECS Packet Practice" page on the county ARES/RACES
    ...
    schedule of simulated "down" BBS systems, and the format of the subject line
    for practice messages.  It is available at
    https://www.scc-ares-races.org/data/packet/weekly-packet-practice.html`,
	refSubjectLine: `
  * The "Standard Packet Message Subject Line" document describes how to compose
    the subject line of a packet message following county standards.  It is
    available from the "Packet BBS Service" page at
    https://www.scc-ares-races.org/data/packet/index.html`,
	refOutpostConfig: `
  * The "Standard Outpost Configuration Instructions" document describes how to
    configure the Outpost messaging software to send messages following county
    standards.  It is available from the "Packet BBS Service" page at
    https://www.scc-ares-races.org/data/packet/index.html`,
	refFormRouting: `
  * The "SCCo ARES/RACES Recommended Form Routing" document gives
    recommendations for, among other things, what handling orders should be used
    for different types of forms.  It is available from the "Go Kit Forms" page
    at https://www.scc-ares-races.org/operations/go-kit-forms.html`,
	refPacketGroup: `
